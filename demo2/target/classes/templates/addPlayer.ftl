...
<#--help-->
            ...
            <form action="/addPlayer" method="post">
                ...
                <div class="row">
                    <div class="col-12">
<#--                        <div>Birth Year:<br>-->
                            <label for="birth_year" class="col-12">Birth Year:</label>
                                <select class="form-control" name="birth_year" size="list">
                                    <#list (thisYear-12)..(thisYear-4) as year>
<#--                                        <#assign yearLong = year?long>-->
<#--                                        <option value="${yearLong}">${(year)?string['0']}</option>-->
